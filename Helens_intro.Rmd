...
The first thing you will need to do is to tell R where our working directory is. This will often be the first thing you put in your script for any project you work on. Copy and paste the code chunk into your script, then 'execute' or 'run' the code by either placing your cursor on the line, or highlighting the line(s), and pressing <kbd>ctrl</kbd> + <kbd>Enter</kbd> (<kbd>cmd</kbd> + <kbd>Enter</kbd> on Macs). In your __console__ you should then get the output seen in the white box.
