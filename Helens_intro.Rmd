...
In later sessions you will use the library ``ggplot2`` to create figures in R. Let's install the library. This can be done with the `install.packages` function, which takes the name of the library as the first argument:
```{r eval = FALSE}
